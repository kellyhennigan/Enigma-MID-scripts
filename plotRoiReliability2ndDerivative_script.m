...
for j = 1:numel(roiNames)
    ...
    for f = 1:nFigs
        ...
        % fig title
        figtitle = [strrep(roiName,'_',' ') ' reliability for 2nd derivative of ' stimStr ];
        ...
        % filepath, if saving
        outDir = fullfile(figDir,'timecourses_2ndderivative_reliablity',roiName);
        if ~exist(outDir,'dir')
            mkdir(outDir)
        end
        ...
        [fig,leg]=plotNiceLines(1:nTRs-2,r,se,cols,lspec,pvals,stims,xlab,ylab,figtitle,[],plotToScreen);
