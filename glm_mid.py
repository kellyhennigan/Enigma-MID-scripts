...
func_files = 'pp_mid_tlrc.nii.gz'

out_dir = os.path.join(data_dir,'results_mid')  	# directory for out files 
...
#-#-#-#-#-#-#-#-#-#-#-		Run 3dDeconvolve:		-#-#-#-#-#-#-#-#-#-#-#
	...
	cmd = ('3dDeconvolve '		
		...
		'-concat '+main_dir+'/scripts/mid_runindices_wEnd.1D '
		...
		'-stim_file 7 '+func_dir+'/mid_csf_ts.1D -stim_base 7 -stim_label 7 csf ' 
		'-stim_file 8 '+func_dir+'/mid_wm_ts.1D -stim_base 8 -stim_label 8 wm ' 
